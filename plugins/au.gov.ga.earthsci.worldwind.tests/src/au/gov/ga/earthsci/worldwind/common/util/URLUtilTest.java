...
public class URLUtilTest
{
	...
	public void testUrlToFileWithFileUrl() throws Exception
	{
		...
		assertEquals("c:\\this\\is\\a\\file.extension", result.getAbsolutePath().toLowerCase());
	}
	...
	{
		assertTrue(URLUtil
				.isForResourceWithExtension(new URL("http://somewhere.com/file.zip?param1=something&"), "zip"));
	}
	...
	{
		assertEquals(new URL("http://somewhere.com/something.html"),
				URLUtil.fromObject("http://somewhere.com/something.html"));
	}
	...
	{
		assertEquals(new URL("http://somewhere.com/something.html"),
				URLUtil.fromObject(new URL("http://somewhere.com/something.html")));
	}
