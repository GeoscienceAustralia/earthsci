...
/**
 * Non-abstract implementation of the {@link AbstractLocalRequesterDelegate} for
 * {@link DelegatorMercatorTextureTile}.
 * 
 * @author Michael de Hoog (michael.dehoog@ga.gov.au)
 */
public class MercatorImageLocalRequesterDelegate extends AbstractLocalRequesterDelegate<DelegatorMercatorTextureTile>
		implements IMercatorImageTileRequesterDelegate
{
	...
	public IDelegate fromDefinition(String definition, Element layerElement, AVList params)
	{
		if (definition.equalsIgnoreCase(DEFINITION_STRING))
			return new MercatorImageLocalRequesterDelegate();
		return null;
	}
}
