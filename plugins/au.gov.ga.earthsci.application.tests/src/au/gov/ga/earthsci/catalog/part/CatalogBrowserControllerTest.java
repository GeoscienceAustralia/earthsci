...
public class CatalogBrowserControllerTest
{
	...
	public void setup()
	{
		...
		mockContext.checking(new Expectations() {{{
			allowing(currentLayerModel).getRootNode(); will(returnValue(rootNode));
		}}});
	...
	public void testAllExistInLayerModelWithSingleExists() throws Exception
	{
		...
		mockContext.checking(new Expectations() {{{
			allowing(rootNode).hasNodesForURI(with(node0.layerURI)); will(returnValue(true));
		}}});
	...
	public void testAllExistInLayerModelWithSingleNotExists() throws Exception
	{
		...
		mockContext.checking(new Expectations() {{{
			allowing(rootNode).hasNodesForURI(with(node0.layerURI)); will(returnValue(false));
		}}});
	...
	public void testAllExistInLayerModelWithMultipleExists() throws Exception
	{
		...
		mockContext.checking(new Expectations() {{{
			allowing(rootNode).hasNodesForURI(with(node0.layerURI)); will(returnValue(true));
			allowing(rootNode).hasNodesForURI(with(node10.layerURI)); will(returnValue(true));
		}}});
	...
	public void testAllExistInLayerModelWithMultipleNotExists() throws Exception
	{
		...
		mockContext.checking(new Expectations() {{{
			allowing(rootNode).hasNodesForURI(with(node0.layerURI)); will(returnValue(true));
			allowing(rootNode).hasNodesForURI(with(node10.layerURI)); will(returnValue(false));
		}}});
