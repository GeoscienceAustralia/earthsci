...
{
	private static final String BUNDLE_NAME = "au.gov.ga.earthsci.common.color.io.messages"; //$NON-NLS-1$
	public static String CompactStringColorMapReader_ReaderDescription;
