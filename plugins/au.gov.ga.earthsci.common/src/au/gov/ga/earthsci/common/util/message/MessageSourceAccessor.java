 ...
 ******************************************************************************/
package au.gov.ga.earthsci.common.util.message;
...
public class MessageSourceAccessor
{
	 ...
	 */
	public static IMessageSource get()
	{
	 ...
	 */
	public static void set(IMessageSource source)
	{
		messageSource = source;
	}

	/**
	 * Helper function that calls addBundle() on the {@link IMessageSource}
