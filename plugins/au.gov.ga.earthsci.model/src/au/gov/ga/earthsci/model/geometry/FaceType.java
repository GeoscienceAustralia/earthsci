 ...
 * <p/>
 * These definitions reflect primitives supported by this geometry, and are
 * defined to reflect the OpenGL standard primitive types, but do not rely on
 * the presence of OpenGL.
 * 
...
public enum FaceType
{
	...
	/**
	 * Linked strip of triangles {@code [v0,v1,v2][v2,v1,v3][v2,v3,v4]} etc.
	 */
	TRIANGLE_STRIP,
	...
	/**
	 * Sets of two vertices used to form lines {@code [v0,v1][v2,v3][v3,v4]}
	 * etc.
	 */
	LINES,

	/**
	 * A linked line of vertices
	 */
	LINE_STRIP,

	/**
	 * As for {@link #LINE_STRIP}, except the first and last vertice will be
	 * joined as a line
	 */
	LINE_LOOP
}
