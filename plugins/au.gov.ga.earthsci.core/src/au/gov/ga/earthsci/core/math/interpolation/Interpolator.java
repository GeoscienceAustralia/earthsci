 ...
 * at a given percentage between a start and end value.
 * <p/>
 * Subclasses might include linear or bezier interpolators and may require
...
public interface Interpolator<V extends Vector<?>>
{
	...
	/**
	 * Compute the interpolated value at the provided percentage along the
	 * interpolation
	 * 
	 * @param percent
	 *            The percentage along the interpolation the value is required
	 *            for. In range <code>[0,1]</code>
	 * 
