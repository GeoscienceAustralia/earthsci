 ...
 * or (more flexibly) via the Eclipse extension point {@code au.gov.ga.earthsci.bookmark.creator}.
 * 
 * <p/>
 * 
 ...
 * or (more flexibly) via the Eclipse extension point {@code au.gov.ga.earthsci.bookmark.exporter}.
 * 
 * <p/>
 * 
 ...
 * or (more flexibly) via the Eclipse extension point {@code au.gov.ga.earthsci.bookmark.applicator}.
 * 
