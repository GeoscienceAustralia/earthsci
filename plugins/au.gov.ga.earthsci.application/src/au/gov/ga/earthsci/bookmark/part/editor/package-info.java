 ...
 * <p/>
 * 
 * The primary component is the {@link au.gov.ga.earthsci.bookmark.part.editor.BookmarkEditorDialog},
 ...
 * with {@link au.gov.ga.earthsci.bookmark.part.editor.BookmarkEditorDialog#open()}.
 * 
 * <pre>
 ...
 * {@link au.gov.ga.earthsci.bookmark.part.editor.IBookmarkPropertyEditor} instances. Subclasses should
 * consider extending the convenience base class 
 * {@link au.gov.ga.earthsci.bookmark.part.editor.AbstractBookmarkPropertyEditor},
 * which has sensible default implementations for several methods.
 * 
 * <p/>
 * 
 * {@link au.gov.ga.earthsci.bookmark.part.editor.IBookmarkPropertyEditor}s instances can be 
 * retrieved from the {@link au.gov.ga.earthsci.bookmark.part.editor.BookmarkPropertyEditorFactory}.
 ...
 * 
 * Editors can be registered on the {@link au.gov.ga.earthsci.bookmark.part.editor.BookmarkPropertyEditorFactory}
 * directly via the {@link au.gov.ga.earthsci.bookmark.part.editor.BookmarkPropertyEditorFactory#registerEditor(String, Class)}
