...
/**
 * An interface for notifications. This represents the model for the notification mechanism.
 * Notifications are rendered in the user interface using one or more renderers.
 * 
...
public interface INotification
{
	...
	/**
	 * @return Whether this notification requires an acknowledgement from the user
	 */
	boolean requiresAcknowledgment();
	
	/**
	 * @return The special action associated with the user acknowledging the notification (if applicable)
	 */
