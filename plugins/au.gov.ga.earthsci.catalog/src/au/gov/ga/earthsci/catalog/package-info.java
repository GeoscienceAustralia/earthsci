 ...
 * In this model, a catalog is a tree structure represented by {@link au.gov.ga.earthsci.catalog.ICatalogTreeNode}s. 
 ...
 * <p/>
 * Multiple catalogs can be available at any one time. These are accessed through the current {@link au.gov.ga.earthsci.catalog.ICatalogModel} instance.
 * 
 */
