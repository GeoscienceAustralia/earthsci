...
public class BasicTimePeriodTest
{
	...
	public void testBuilderWithValidNoSubPeriod()
	{
		...
		BasicTimePeriod classUnderTest =
				Builder.buildTimePeriod(id, name, description).from(start, true).to(end, true).atLevel(level1).build();
	...
	public void testBuilderWithNoRange()
	{
		...
		BasicTimePeriod classUnderTest = Builder.buildTimePeriod(id, name, description).atLevel(level1).build();
	...
	public void testBuilderWithNoLevel()
	{
		...
		Builder.buildTimePeriod(id, name, description).from(start, true).to(end, true).atLevel(null).build();
	}

	@Test
	public void testBuilderWithValidSubPeriod()
	{
		BasicTimePeriod period1 = Builder.buildTimePeriod("id1", "name1", "description1").atLevel(level2).build();

		BasicTimePeriod period2 =
				Builder.buildTimePeriod("id2", "name2", "description2").atLevel(level1).withSubPeriod(period1).build();
	...
	public void testBuilderWithSubPeriodSameLevel()
	{
		...
		Builder.buildTimePeriod("id2", "name2", "description2").atLevel(level2).withSubPeriod(period1).build();
	}

	@Test(expected = IllegalArgumentException.class)
	public void testBuilderWithSubPeriodHigherLevel()
	{
		BasicTimePeriod period1 = Builder.buildTimePeriod("id1", "name1", "description1").atLevel(level1).build();
	...
	public void testBuilderWithSubPeriodSameId()
	{
		...
		Builder.buildTimePeriod("id1", "name2", "description2").atLevel(level1).withSubPeriod(period1).build();
	}

	@Test
	public void testBuilderWithSubPeriodSameName()
	{
		BasicTimePeriod period1 = Builder.buildTimePeriod("id1", "name", "description1").atLevel(level2).build();

		BasicTimePeriod period2 =
				Builder.buildTimePeriod("id2", "name", "description2").atLevel(level1).withSubPeriod(period1).build();
	...
	{
		BasicTimePeriod period1 = Builder.buildTimePeriod("id1", "name1", "description").atLevel(level2).build();

		BasicTimePeriod period2 =
				Builder.buildTimePeriod("id2", "name2", "description").atLevel(level1).withSubPeriod(period1).build();
	...
	{
		BasicTimePeriod period1 =
				Builder.buildTimePeriod("id1", "name1", "description")
						.from(new BigTime(BigInteger.valueOf(1000)), true)
						.to(new BigTime(BigInteger.valueOf(10000)), true).atLevel(level2).build();

		BasicTimePeriod period2 =
				Builder.buildTimePeriod("id2", "name2", "description")
						.from(new BigTime(BigInteger.valueOf(1000)), true)
						.to(new BigTime(BigInteger.valueOf(20000)), true).atLevel(level1).withSubPeriod(period1)
						.build();
	...
	{
		BasicTimePeriod period1 =
				Builder.buildTimePeriod("id1", "name1", "description").from(new BigTime(BigInteger.valueOf(999)), true)
						.to(new BigTime(BigInteger.valueOf(10000)), true).atLevel(level2).build();

		BasicTimePeriod period2 =
				Builder.buildTimePeriod("id2", "name2", "description")
						.from(new BigTime(BigInteger.valueOf(1000)), true)
						.to(new BigTime(BigInteger.valueOf(10000)), true).atLevel(level1).withSubPeriod(period1)
						.build();
	...
	public void testContainsWithNull()
	{
		...
		BasicTimePeriod period1 =
				Builder.buildTimePeriod("id", "name", "description").from(start, true).to(end, true).atLevel(level1)
						.build();
	...
	{
		BasicTimePeriod sub1 =
				Builder.buildTimePeriod("sub1", "sub1", "sub1").to(new BigTime(BigInteger.ZERO), true).atLevel(level2)
						.build();

		BasicTimePeriod sub2 =
				Builder.buildTimePeriod("sub2", "sub2", "sub2").from(new BigTime(BigInteger.ONE), true).atLevel(level2)
						.build();

		BasicTimePeriod period =
				Builder.buildTimePeriod("parent", "parent", "parent").atLevel(level1).withSubPeriods(sub1, sub2)
						.build();
	...
	public void testDefaultLabelProviderOverlappingSubPeriods()
	{
		...
		BasicTimePeriod sub2 =
				Builder.buildTimePeriod("sub2", "sub2", "sub2").from(new BigTime(BigInteger.valueOf(-10)), true)
						.atLevel(level2).build();
	...
	public void testEqualsWithSameId()
	{
		...
		BasicTimePeriod period2 = Builder.buildTimePeriod("id1", "name2", "description2").atLevel(level2).build();
	...
	public void testEqualsWithDifferentId()
	{
		...
		BasicTimePeriod period2 = Builder.buildTimePeriod("id2", "name2", "description2").atLevel(level2).build();
