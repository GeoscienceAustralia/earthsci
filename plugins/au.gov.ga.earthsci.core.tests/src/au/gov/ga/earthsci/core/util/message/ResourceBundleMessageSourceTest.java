...
public class ResourceBundleMessageSourceTest
{
	...
	private ResourceBundleMessageSource classToBeTested = new ResourceBundleMessageSource("au.gov.ga.earthsci.core.util.message.testMessages1",
																						  "au.gov.ga.earthsci.core.util.message.testMessages2");
