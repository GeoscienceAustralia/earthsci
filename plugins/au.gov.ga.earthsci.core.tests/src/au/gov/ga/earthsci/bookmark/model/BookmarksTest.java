...
public class BookmarksTest
{
	...
	public void testEmptyDefaultListExistsOnCreate()
	{
		...
		assertEquals(classUnderTest.getDefaultList(),
				classUnderTest.getListById(classUnderTest.getDefaultList().getId()));
		assertEquals(classUnderTest.getDefaultList(),
				classUnderTest.getListByName(classUnderTest.getDefaultList().getName()));
	}
	...
	{
		IBookmarkList[] lists =
				new IBookmarkList[] { new BookmarkList("id0", "name0"), new BookmarkList("id1", "name1") };
	...
	{
		IBookmarkList[] newLists =
				new IBookmarkList[] { new BookmarkList("id0", "name0"), new BookmarkList("id1", "name1"),
						new BookmarkList("id2", "name2") };
